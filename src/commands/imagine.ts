...
module.exports = {
	command: new SlashCommandBuilder()
		...
		.addStringOption((builder) =>
			builder
				...
				.setDescriptionLocalization(
					"tr",
					"Çizdirmek istediğiniz resmin betimlemesi"
				)
				.setRequired(true)
				.setMaxLength(1000)
		)
		.addStringOption((builder) =>
			builder
				...
				.setDescriptionLocalization(
					"tr",
					"Çizdirmekten kaçınmak istediğiniz şey."
				)
				.setRequired(false)
				.setMaxLength(1000)
		)
		.addStringOption((builder) =>
			builder
				...
				.setDescriptionLocalization(
					"tr",
					"Kullanmak istediğiniz yapay zeka modeli."
				)
				.setChoices(
		...
		.addIntegerOption((builder) =>
			builder
				...
				.setDescriptionLocalization(
					"tr",
					"Resmin yüksekliğini ayarlamınızı sağlar."
				)
				.setMinValue(100)
				.setMaxValue(1536)
				.setRequired(false)
		...
		.addIntegerOption((builder) =>
			builder
				...
				.setDescriptionLocalization(
					"tr",
					"Resmin genişliğini ayarlamanızı sağlar."
				)
				.setMinValue(100)
				.setMaxValue(1536)
				.setRequired(false)
		...
		.addIntegerOption((builder) =>
			builder
				...
				.setDescriptionLocalization(
					"tr",
					"Resmin seed'ini ayarlamanızı sağlar."
				)
				.setMinValue(-1)
				.setRequired(false)
		)
	...
	execute: async (interaction, dbuser, userRole, dbGroup) => {
		const model: "anime" | "sdxl" =
			(interaction.options.getString("model") as "anime" | "sdxl" | null) ||
			"sdxl";
					...
					embeds: [
						interaction.locale === "tr"
							...
							: new EmbedBuilder()
									.setColor("#de1717")
									.setTitle(
										"You cannot draw this kind of image on this channel!"
									)
									.setDescription(
										"You have recieved a penalty of 10000 tokens!"
									),
					],
					ephemeral: true,
				});
				...
				embeds: [
					interaction.locale === "tr"
						...
						: new EmbedBuilder()
								...
								.setDescription(
									`There are ${result.queueSize} people in the queue!`
								)
								.setColor("#00ffd0"),
				],
			});
				...
				embeds: [
					interaction.locale === "tr"
						? new EmbedBuilder()
								...
								.setDescription(
									`Lütfen destek için "vmut" kullanıcısna ulaşın.`
								)
								.setColor("#ffe200")
						: new EmbedBuilder()
